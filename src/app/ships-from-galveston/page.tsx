            ...
            >
              <div className={`bg-gradient-to-r ${line.color} text-white p-6 flex items-center gap-4`}>
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm mt-1 max-w-2xl">{line.description}</p>
                </div>
              </div>
              <div className="p-6">
                <h4 className="font-bold text-blue-900 mb-5 text-sm uppercase tracking-wide">
                ...
                {"onBoard" in line && Array.isArray(line.onBoard) && (
                  <div className="mt-8">
                    <div className="flex items-center gap-3 mb-5">
                      ...
                      <h4 className="font-bold text-orange-600 text-sm uppercase tracking-wide whitespace-nowrap">
                        ✨ The Disney Experience On Board
                      </h4>
                      <div className="h-px flex-1 bg-yellow-200" />
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {line.onBoard.map((exp: { icon: string; title: string; desc: string }) => (
                        <div
                          key={exp.title}
                          className="bg-gradient-to-br from-yellow-50 to-orange-50 border border-yellow-200 rounded-xl p-5"
                        >
                          <div className="flex items-center gap-2 mb-2">
                            <span className="text-2xl">{exp.icon}</span>
                            <h5 className="font-extrabold text-blue-900 text-sm">{exp.title}</h5>
                          </div>
